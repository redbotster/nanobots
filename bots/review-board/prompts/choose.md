...
- If a roster of available roles is given above, pick **only** from it, and copy each chosen role's name and focus verbatim. That roster is the team this person has actually configured; inventing a role they don't have produces a reviewer they can't tune and can't reuse.
